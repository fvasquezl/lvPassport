...
it('a super-admin can update a non-super-admin role', function () {
    ...
    $this->jsonApi()
        ...
        ->patch(route('api.v1.roles.update', $role))
        ->assertOk();
...
it('the super-admin role cannot be deleted', function () {
    ...
    $this->jsonApi()
        ->delete(route('api.v1.roles.destroy', $superAdmin))
        ->assertForbidden();
...
it('the super-admin role cannot be updated', function () {
    ...
    $this->jsonApi()
        ...
        ->patch(route('api.v1.roles.update', $superAdmin))
        ->assertForbidden();
